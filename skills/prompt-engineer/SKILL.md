...
version: 1.0.0
description: |
  Use when you need a prompt engineer to transform rough ideas into optimized
  prompts for specific AI platforms and media types.
...
- `references/prompt-engineer.md`
- `references/nano-banana-README_pt-BR.md`
