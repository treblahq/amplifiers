...
version: 1.0.0
description: |
  Use when you need a Laravel architect to define clean controllers, services,
  requests, resources, jobs, integrations, and backend boundaries.
...
- `references/laravel-architect.md`
