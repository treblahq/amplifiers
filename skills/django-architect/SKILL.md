...
version: 1.0.0
description: |
  Use when you need a Django architect to structure DRF APIs with clean layers,
  selectors, services, serializers, views, naming rules, and project boundaries.
...
- `references/django-architect.md`
