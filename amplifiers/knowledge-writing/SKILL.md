...
version: 1.0.0
source: trebla/co-workers/knowledge-writter
description: |
  Map, structure, and write modular project documentation from a codebase.
  Produces clean, English, snake_case documentation separated by topic and
  indexed through a README.md.
